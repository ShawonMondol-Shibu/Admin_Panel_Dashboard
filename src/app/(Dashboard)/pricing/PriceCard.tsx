...
<Card className='px-5 py-10 w-fit max-w-sm'>
    <CardHeader className='border-b text-center'>
        ...
        <CardDescription className='text-base'>Monthly Charge
            <p className='text-5xl font-extrabold text-[var(--colorSkyBlue)] mt-4'>$14.99</p>
        </CardDescription>
    </CardHeader>
    <CardContent className='border-b text-center text-lg'>
<p>
    Free Setup
</p>
